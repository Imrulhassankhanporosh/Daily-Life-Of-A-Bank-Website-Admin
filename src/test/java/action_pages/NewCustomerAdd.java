...
//        Thread.sleep(2000);
        ...
        name.sendKeys("jiya Heyden");
        Thread.sleep(2000);
        gender.click();
        Thread.sleep(2000);
        dob.sendKeys("06/10/1993");
        Thread.sleep(2000);
        address.sendKeys("Some where in the world around us");
        Thread.sleep(2000);
        city.sendKeys("XYZ");
        Thread.sleep(2000);
        state.sendKeys("ABCX");
        ...
        pin.sendKeys("102030");
        Thread.sleep(2000);
        mobile_no.sendKeys("01716661620");
        Thread.sleep(2000);
        String email_id = "Test" + System.currentTimeMillis() + "@acb.com";
        Thread.sleep(2000);
